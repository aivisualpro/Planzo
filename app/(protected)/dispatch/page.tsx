...
const initialDispatchCards = [
  { name: "Roster", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Performance Dashboard", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Opening", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Attendance", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Repairs", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Loadout", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Time", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Schedule", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Closing", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Contacts", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Verbal Coaching", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Messaging", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Efficiency", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Routes", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Incidents", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Coaching", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Checklist", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
];

export default function DispatchPage() {
  const router = useRouter();
  const [cards, setCards] = useState(initialDispatchCards);
  const [isSuperAdmin, setIsSuperAdmin] = useState(false);
  
  // Load saved card config from DB and check role on mount
  useEffect(() => {
    fetch("/api/card-config?page=dispatch")
      .then(res => res.json())
      .then(data => {
  ...
  const saveCard = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/card-config", {
        ...
        body: JSON.stringify({ page: "dispatch", cards: cardData }),
      });
