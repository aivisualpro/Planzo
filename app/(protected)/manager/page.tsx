...
const initialManagerCards = [
  { name: "Routes Manager", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Punch Ins Manager", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Punch Ins Import", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "RTS Manager", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Rescue Manager", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Driver Efficiency Manager", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Performance Summary", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Scorecard Performance", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Employee Ranking", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "HR Tickets Managers", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Notices", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Work Hours Compliance", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Paycom Schedule Export", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Work Summary Tool", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Fleet Summary", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Repairs", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Scorecard History", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
  { name: "Weekly ScoreCard", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "/reports/employee-performance-dashboard" },
  { name: "Lunch Compliance", bgDark: DEFAULT_DARK_IMAGE, bgLight: DEFAULT_LIGHT_IMAGE, route: "#" },
];

export default function ManagerPage() {
  const router = useRouter();
  const [cards, setCards] = useState(initialManagerCards);
  const [isSuperAdmin, setIsSuperAdmin] = useState(false);

  // Load saved card config from DB and check role on mount
  useEffect(() => {
    fetch("/api/card-config?page=manager")
      .then(res => res.json())
      .then(data => {
  ...
  const saveCard = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/card-config", {
        ...
        body: JSON.stringify({ page: "manager", cards: cardData }),
      });
            ...
            <div className="relative z-10 flex flex-col justify-between h-full p-5">
              ...
              <div className="bg-white/15 dark:bg-black/20 backdrop-blur-md rounded-lg px-4 py-3 border border-white/25 dark:border-white/10 shadow-sm">
                <h3
                  ...
                  className="text-2xl uppercase tracking-wide drop-shadow-md text-zinc-900 dark:text-white group-hover:text-primary transition-colors duration-300"
                >
                  {card.name}
                </h3>
              </div>
