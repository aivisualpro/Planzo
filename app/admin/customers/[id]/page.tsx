...
export default function CustomerDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const allShippings = filteredCustomerPOs.flatMap(cpo => 
    (cpo.shipping || []).map(ship => ({
      ...ship,
  ...
  const filteredShippings = (selectedCpoId 
    ...
    : allShippings).map((ship: any) => {
      // Find the PO and CPO indexes for updates
      const po = purchaseOrders.find(p => p._id === ship.vbpoId);
      const cpoIdx = po?.customerPO.findIndex(c => c._id === ship.parentCpoId) ?? -1;
      const shipIdx = po?.customerPO[cpoIdx]?.shipping?.findIndex(s => s._id === ship._id) ?? -1;
      return { ...ship, _poId: ship.vbpoId, _cpoIdx: cpoIdx, _shipIdx: shipIdx };
    });
  ...
  return (
    <TooltipProvider>
      ...
      <div className="grid grid-cols-12 gap-6 p-6 h-full overflow-hidden">
        {/* Column 1: Locations */}
        <div className="col-span-2 flex flex-col gap-4 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-muted">
            ...
            {customer.location && customer.location.length > 0 ? (
              customer.location.map((loc: CustomerLocation, idx) => (
                <div 
                  ...
                  className={cn(
                    "group relative h-60 overflow-hidden rounded-3xl bg-card text-card-foreground border shadow-none transition-all duration-500 hover:-translate-y-2 cursor-pointer",
                    selectedLocationId === loc.vbId ? "border-primary ring-1 ring-primary" : "border-border hover:border-primary/40"
                  )}
                >
                  ...
                  <div className="absolute inset-0 p-5 flex flex-col justify-end gap-1.5 z-10">
                    <div className="space-y-1">
                      ...
                      {/* 2nd Row: vbId */}
                      <div className="inline-flex px-1.5 py-0.5 bg-foreground/5 dark:bg-white/10 rounded-md border border-foreground/5">
                    ...
                    <div className="bg-muted/30 dark:bg-foreground/5 rounded-2xl border border-border/50 relative z-10 flex flex-col mt-4">
                        ...
                        <div className="grid grid-cols-5 gap-0 p-2 border-b border-border/30">
                             ...
                             <div className="flex flex-col items-center gap-1.5 text-center border-r border-border/50 px-1">
                                ...
                                <Switch checked={!!ship.isArrivalNotice} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isArrivalNotice', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                            {/* Genset Req */}
                            <div className="flex flex-col items-center gap-1.5 text-center border-r border-border/50 px-1">
                                <p className="text-[9px] font-black uppercase text-muted-foreground">Genset Req</p>
                                <Switch checked={!!ship.isGensetRequired} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isGensetRequired', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                            {/* Genset Inv */}
                            <div className="flex flex-col items-center gap-1 text-center border-r border-border/50 px-1 pt-1.5">
                             ...
                             <div className="flex flex-col items-center gap-1.5 text-center border-r border-border/50 px-1">
                                ...
                                <Switch checked={!!ship.gensetEmailed} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'gensetEmailed', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                             {/* Collect Fees */}
                             <div className="flex flex-col items-center gap-1.5 text-center px-1">
                                ...
                                <Switch checked={!!ship.isCollectFeesPaid} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isCollectFeesPaid', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-5 gap-0 p-2 border-b border-border/30">
                            ...
                            <div className="flex flex-col items-center gap-1 text-center border-r border-border/50 px-1 pt-1.5">
                             ...
                             <div className="flex flex-col items-center gap-1.5 text-center border-r border-border/50 px-1">
                                ...
                                <Switch checked={!!ship.isDOCreated} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isDOCreated', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                             {/* Sup Inv */}
                             <div className="flex flex-col items-center gap-1.5 text-center border-r border-border/50 px-1">
                                <p className="text-[9px] font-black uppercase text-muted-foreground">Sup Inv</p>
                                <Switch checked={!!ship.isSupplierInvoice} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isSupplierInvoice', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                             {/* Man Sec ISF */}
                             <div className="flex flex-col items-center gap-1.5 text-center px-1">
                                <p className="text-[9px] font-black uppercase text-muted-foreground">Man Sec ISF</p>
                                <Switch checked={!!ship.isManufacturerSecurityISF} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isManufacturerSecurityISF', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-5 gap-0 p-2 border-b border-border/30">
                             ...
                             <div className="flex flex-col items-center gap-1.5 text-center border-r border-border/50 px-1">
                                ...
                                <Switch checked={!!ship.isVidaBuddiesISFFiling} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isVidaBuddiesISFFiling', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                             {/* Pack List */}
                             <div className="flex flex-col items-center gap-1.5 text-center border-r border-border/50 px-1">
                                <p className="text-[9px] font-black uppercase text-muted-foreground">Pack List</p>
                                <Switch checked={!!ship.isPackingList} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isPackingList', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                             {/* Cert Analysis */}
                             <div className="flex flex-col items-center gap-1.5 text-center border-r border-border/50 px-1">
                                <p className="text-[9px] font-black uppercase text-muted-foreground">Cert Analysis</p>
                                <Switch checked={!!ship.isCertificateOfAnalysis} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isCertificateOfAnalysis', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                             {/* Cert Origin */}
                             <div className="flex flex-col items-center gap-1.5 text-center border-r border-border/50 px-1">
                                <p className="text-[9px] font-black uppercase text-muted-foreground">Cert Origin</p>
                                <Switch checked={!!ship.isCertificateOfOrigin} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isCertificateOfOrigin', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                             {/* Bill of Lading */}
                             <div className="flex flex-col items-center gap-1.5 text-center px-1">
                                <p className="text-[9px] font-black uppercase text-muted-foreground">Bill of Lading</p>
                                <Switch checked={!!ship.IsBillOfLading || !!ship.isBillOfLading} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'IsBillOfLading', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-5 gap-0 p-2">
                             ...
                             <div className="flex flex-col items-center gap-1.5 text-center border-r border-border/50 px-1">
                                ...
                                <Switch checked={!!ship.isAllDocumentsProvidedToCustomsBroker} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isAllDocumentsProvidedToCustomsBroker', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                             {/* Customs Stat */}
                             <div className="flex flex-col items-center gap-1.5 text-center border-r border-border/50 px-1">
                                <p className="text-[9px] font-black uppercase text-muted-foreground">Customs Stat</p>
                                <Switch checked={!!ship.isCustomsStatus} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isCustomsStatus', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                             {/* Drayage Asg */}
                             <div className="flex flex-col items-center gap-1.5 text-center border-r border-border/50 px-1">
                                <p className="text-[9px] font-black uppercase text-muted-foreground">Drayage Asg</p>
                                <Switch checked={!!ship.IsDrayageAssigned} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'IsDrayageAssigned', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                             {/* Trucker Notif */}
                             <div className="flex flex-col items-center gap-1 text-center border-r border-border/50 px-1 pt-1.5">
                             ...
                             <div className="flex flex-col items-center gap-1.5 text-center px-1">
                                ...
                                <Switch checked={!!ship.isTruckerReceivedDeliveryOrder} onCheckedChange={(v) => updateShippingField(ship._poId, ship._cpoIdx, ship._shipIdx, 'isTruckerReceivedDeliveryOrder', v)} className="scale-75 data-[state=checked]:bg-primary" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-4 relative z-10 border-t border-border/30">
                        <div className="flex items-center gap-4">
                            <div className="flex flex-col">
                                ...
                                <p className="text-[10px] font-bold uppercase">{users[ship.createdBy?.toLowerCase()] || ship.createdBy || 'System'}</p>
                            </div>
                        </div>
